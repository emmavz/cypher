...
/***/ "./resources/js/admin/admin-functions.js":
/*!***********************************************!*\
  !*** ./resources/js/admin/admin-functions.js ***!
  \***********************************************/
...
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main */ "./resources/js/admin/main.js");

$(function () {
  // Authentication
  $('.login-form').on('submit', function () {
    (0,_main__WEBPACK_IMPORTED_MODULE_0__.ajaxRequest)(route('admin.login'), $(this).serialize(), $(this));
  });
  $('.forgot-pass-form').on('submit', function () {
    (0,_main__WEBPACK_IMPORTED_MODULE_0__.ajaxRequest)(route('admin.password.email'), $(this).serialize(), $(this));
  });
  $('.set-newpass-form').on('submit', function () {
    (0,_main__WEBPACK_IMPORTED_MODULE_0__.ajaxRequest)(route('admin.password.update'), $(this).serialize(), $(this));
  }); // Profile

  $('.profile-update-form').on('submit', function () {
    (0,_main__WEBPACK_IMPORTED_MODULE_0__.ajaxRequest)(route('admin.profile.update'), new FormData(this), $(this));
  });
});
...
$(function () {
  ...
  $(document).on('click', '.checkbx', checkAllTrue); // Sortable Rows

  var $sortableWrap = $('.sortable-update-wrap'),
...
__webpack_require__(/*! ./admin-functions */ "./resources/js/admin/admin-functions.js");
/****************************** SELLER Starts ******************************/
...
function ajaxFailed(e, errors, errorsContainer) {
  ...
  if (errors || e.status == 422) {
    var layout = '<div class="alert alert-danger" role="alert">' + '<button type="button">×</button>' + '<strong>Errors:</strong>' + '<ol>';
...
function updateRows(e) {
  ...
  ajaxForm(route1, data, $sortableWrap, 'PUT').done(function (r) {
    $sortableWrap.fadeOut(200);
  });
} // Delete Single Row
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/admin/main.js");
/******/ 	
/******/ })()
;