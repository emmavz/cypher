...
export default ({
    data() {
        return {
            ...
            //         "id": 2,
            //         "title": "Desiree King",
            //         "image_url": "http://localhost:8000/storage/dynamic/post-8.png",
            //         "name": "Writes about",
            //         "user": {
            //             "pfp": "http://localhost:8000/storage/dynamic/profile-6.png",
            //         },
            //         "tags": [
            //             { name: 'Luxary'},
            //             { name: 'Cat'}
                    ...
                    <template v-slot:tabPanel-1>
                        <template v-if="articles.length">
                            <div class="w-full flex justify-center container" v-for="(article,index) in articles"
                                :key="index">
                                <Article :article="article" :url="{ name: 'profile', params: { userId: article.id  } }"
